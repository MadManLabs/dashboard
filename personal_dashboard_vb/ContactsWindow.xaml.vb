...
Public Class ContactsWindow
        ...
        Dim thread As New Thread(
         Sub()
            ...
            "server=localhost;uid=root;password=password;database=vbdashboard"
             MysqlConn.Open()
             Try
                 Dim Query As String = "insert into vbdashboard.contact (name,mail,phone,belong) values ('" + Name + "','" + Mail + "','" + Phone + "','" + UserData.Id.ToString + "')"
    ...
    Private Sub Button_Click_2(sender As Object, e As RoutedEventArgs)
        ...
        MysqlConn.Open()
        Try
            Dim Query As String = "delete from vbdashboard.contact where belong = " + UserData.Id.ToString + " and name = '" + DetailNameLabel.Content + "'"
            COMMAND = New MySqlCommand(Query, MysqlConn)
            COMMAND.ExecuteNonQuery()
            MysqlConn.Close()
        Catch ex As MySqlException
